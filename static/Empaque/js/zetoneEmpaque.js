    ...
    function(data){
      ...
      try {
        ...
        if(arrayData.message == "Success"){
          ...
          let descarga =  `<a href="http://191.97.47.114:8000/empaque/reportes/donwload/${arrayData.pdf}"><button type="button" class="button" onclick="hideButton()" id="descargaPDF">Descargar</button></a>`;
