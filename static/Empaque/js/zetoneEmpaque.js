    ...
    function(data){
      ...
      try {
        ...
        if(arrayData.message == "Success"){
          hideProgessBar();
          let descargaPDF =  `<button type="button" class="button" onclick="hideButton()" id="descargaPDF"><a href="http://10.32.26.35/empaque/reportes/donwload/${arrayData.pdf}">Descargar</a></button>`;
          document.getElementById('descargarReportesCamaras').innerHTML = descargaPDF;
